...
#define LCD_GPIO_CS_N_BASE (uint16_t)2        // LCD 1 chip select
#define LCD1_GPIO_CS_N LCD_GPIO_CS_N_BASE     // LCD 1 chip select
#define LCD2_GPIO_CS_N LCD_GPIO_CS_N_BASE + 1 // LCD 2 chip select
#define LCD3_GPIO_CS_N LCD_GPIO_CS_N_BASE + 2 // LCD 3 chip select
#define LCD4_GPIO_CS_N LCD_GPIO_CS_N_BASE + 3 // LCD 4 chip select
#define LCD5_GPIO_CS_N LCD_GPIO_CS_N_BASE + 4 // LCD 5 chip select
#define LCD6_GPIO_CS_N LCD_GPIO_CS_N_BASE + 5 // LCD 6 chip select
#define LCD7_GPIO_CS_N LCD_GPIO_CS_N_BASE + 6 // LCD 7 chip select
#define LCD_GPIO_CLK (uint16_t)10             // Shared clock
#define LCD_GPIO_MOSI (uint16_t)11            // Shared MOSI (DIN)
#define LCD_GPIO_RST_N (uint16_t)12           // Shared LCD reset
